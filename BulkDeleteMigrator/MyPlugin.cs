...
namespace BulkDeleteMigrator
{
    [Export(typeof(IXrmToolBoxPlugin)),
        ...
        ExportMetadata("Description", "A tool to view, validate, and clone recurring and non-recurring Bulk Deletion jobs across environments."),
        ...
        ExportMetadata("SecondaryFontColor", "#E1E1E1")]
